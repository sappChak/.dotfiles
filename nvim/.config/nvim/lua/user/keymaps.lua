...
nnoremap("<leader>se", require("telescope.builtin").live_grep, { desc = "[S]earch by [G]rep" })
...
M.map_lsp_keybinds = function(buffer_number)
	...
	nnoremap("<C-l>", vim.lsp.buf.code_action, { desc = "LSP: [C]ode [A]ction", buffer = buffer_number })
...
tnoremap("<esc>", [[<C-\><C-n>]])
tnoremap("jj", [[<C-\><C-n>]])
nnoremap("<leader>t", ":terminal<CR>", { desc = "Open terminal in normal mode" })
